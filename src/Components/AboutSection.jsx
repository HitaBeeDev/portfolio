...
function AboutSection() {
  return (
    <section id="about" className="lg:grid lg:grid-cols-12 gap-10">
      <div className="lg:col-span-9 lg:p-10 p-5 border-l border-t border-color2">
        ...
        <p className="tracking-widest font-thin leading-relaxed lg:text-[0.9rem] text-[0.75rem] lg:mt-7 mt-3 text-color5">
          ...
          background. Beginning my journey in 2022, I've actively contributed to
          crafting diverse digital products for numerous companies. From dynamic
          marketing websites to intricate enterprise solutions, I prioritize
          delivering swift, refined, and user-friendly experiences.
          <br />
          <br />
          Throughout my career, I've collaborated with talented individuals to
          tailor impactful digital solutions to meet both business and consumer
          needs. Leveraging my extensive experience and profound understanding
          of design principles, I offer a distinctive perspective to the
          development process.
          <br />
          <br />
          My goal isn't just about aesthetics; it's about creating intuitive web
          applications that are user-friendly and accessible. By combining
